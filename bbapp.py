...
class App:
    ...
    def update_buttons(self, choice1, choice2, dim):
        ...
        self.euclid_avg = bbprocessrel.average(self.euclid_left, self.euclid_right, dim)
    ...
    def first_pass(self, dim, emotion):
        ...
        ans.a1.euclid, ans.a.euclid, ans.a2.euclid = bbprocessrel.set_choices(ans.a.val, ranges, dim, 1, emotion)
    ...
    def a_pass(self, dim, passno, ans, emotion):
        ...
        ans2.a1.euclid, ans2.a.euclid, ans2.a2.euclid = bbprocessrel.set_choices(ans2.a.val, ranges, dim, passno, emotion)
