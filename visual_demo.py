...
class App:
    ...
    def play_choices(self):
        # uncomment the line immediately below and comment the rest to turn off playback
        # pass
    ...
    def update_buttons(self, choice1, choice2, dim):
        ...
        self.euclid_avg = visual_demo_process.average(self.euclid_left, self.euclid_right, dim)
    ...
    def full_trial(self, participant):
        self.test_trial()
        plt_left, plt_right = visual_demo_process.plot_background()
        self.emotion_trial(participant.happy, plt_left, plt_right)
        self.emotion_trial(participant.depressed, plt_left, plt_right)
        self.emotion_trial(participant.grief_stricken, plt_left, plt_right)
        self.take_a_break()
        self.emotion_trial(participant.scared, plt_left, plt_right)
        self.emotion_trial(participant.angry, plt_left, plt_right)
    ...
    def emotion_trial(self, emotion, plt_left, plt_right):
        ...
        pms1 = self.first_pass(0, neutral, plt_left, plt_right)
        vtl1 = self.first_pass(1, self.euclid, plt_left, plt_right)
        df1 = self.first_pass(2, self.euclid, plt_left, plt_right)
        prf1 = self.first_pass(3, self.euclid, plt_left, plt_right)
        pms2 = self.a_pass(0, 2, pms1, self.euclid, plt_left, plt_right)
        vtl2 = self.a_pass(1, 2, vtl1, self.euclid, plt_left, plt_right)
        df2 = self.a_pass(2, 2, df1, self.euclid, plt_left, plt_right)
        prf2 = self.a_pass(3, 2, prf1, self.euclid, plt_left, plt_right)
        pms3 = self.a_pass(0, 3, pms2, self.euclid, plt_left, plt_right)
        vtl3 = self.a_pass(1, 3, vtl2, self.euclid, plt_left, plt_right)
        df3 = self.a_pass(2, 3, df2, self.euclid, plt_left, plt_right)
        prf3 = self.a_pass(3, 3, prf2, self.euclid, plt_left, plt_right)
        pms4 = self.a_pass(0, 4, pms3, self.euclid, plt_left, plt_right)
        vtl4 = self.a_pass(1, 4, vtl3, self.euclid, plt_left, plt_right)
        df4 = self.a_pass(2, 4, df3, self.euclid, plt_left, plt_right)
        prf4 = self.a_pass(3, 4, prf3, self.euclid, plt_left, plt_right)
        pms5 = self.a_pass(0, 5, pms4, self.euclid, plt_left, plt_right)
        # vtl5 = self.a_pass(1, 5, vtl4, self.euclid, plt_left, plt_right)
        # df5 = self.a_pass(2, 5, df4, self.euclid, plt_left, plt_right)
        prf5 = self.a_pass(3, 5, prf4, self.euclid, plt_left, plt_right)
    ...
    def first_pass(self, dim, emotion, plt_left, plt_right):
        message = '\npass {}, dimension {}'
        ...
        ans.a1.euclid, ans.a.euclid, ans.a2.euclid = visual_demo_process.set_choices(ans.a.val, ranges, dim, 1, emotion)
        ...
        visual_demo_process.plot_line(plt_left, plt_right, ranges[dim], emotion, dim)
        visual_demo_process.plot_euclid(plt_left, plt_right, ans.a1, ans.a2)
        self.window.after(500, lambda: self.play_choices())
        self.sound_left.wait_variable(self.current_button)
        ...
        visual_demo_process.plot_euclid(plt_left, plt_right, ans.stage2[0], ans.stage2[1])
        self.play_choices()
    ...
    def a_pass(self, dim, passno, ans, emotion, plt_left, plt_right):
        message = '\npass {}, dimension {}'
        ...
        ans2.a1.euclid, ans2.a.euclid, ans2.a2.euclid = visual_demo_process.set_choices(ans2.a.val, ranges, dim, passno, emotion)
        ...
        visual_demo_process.plot_line(plt_left, plt_right, ranges[dim], emotion, dim)
        visual_demo_process.plot_euclid(plt_left, plt_right, stage1[0], stage1[1])
        self.play_choices()
        self.sound_left.wait_variable(self.current_button)
        self.log.append('Button pressed: ' + str(self.current_button.get()))
        ...
        if ans2.a.winner and ans2.a1.euclid != ans2.a.euclid and ans2.a.euclid != ans2.a2.euclid:
            ...
            visual_demo_process.plot_euclid(plt_left, plt_right, ans2.stage2[0], ans2.stage2[1])
            self.play_choices()
            self.sound_average.grid()
            self.sound_left.wait_variable(self.current_button)
            self.log.append('Button pressed: ' + str(self.current_button.get()))
